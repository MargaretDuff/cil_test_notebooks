...
from cil.optimisation.functions import  KullbackLeibler, WeightedL2NormSquared, L2NormSquared, \
    ...
    SmoothMixedL21Norm, OperatorCompositionFunction, \
     IndicatorBox,  SumFunction, SumScalarFunction, \
...
func= TotalVariation(backend='c', warm_start=False, max_iteration=1)
x=ig.allocate(1)

#%% 
func.proximal(x, 0.5, out=x)
#%%